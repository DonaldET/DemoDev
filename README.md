...
These short examples demonstrate _less than the best_ coding practices that are sometimes used to get around a solution constraint until a better solution can be found.
