...
def main():
    ...
    print("\nCUDA GPU Description")
    print("Compute: 7.5;  Data Center: NVIDIA T4;  Workstation: GeForce RTX 2080")
    print("Compute: 5.2;  Data Center: NVIDIA;     Workstation: GeForce GTX 970M")
    print("\nShow Available GPUs")
