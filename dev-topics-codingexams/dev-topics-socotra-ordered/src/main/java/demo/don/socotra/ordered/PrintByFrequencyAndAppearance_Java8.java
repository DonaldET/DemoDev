...
/**
 * Order by frequency and then order of appearance, using the Java 8 MAP 'merge' method.
 *
 * <pre>
 * <code>
 ...
 * @author Don Trummell
 */
public class PrintByFrequencyAndAppearance_Java8 {
	public PrintByFrequencyAndAppearance_Java8() {
	}

	public static void main(String[] args) {
		System.out.println("\nOrder lists by frequency and then order-of-appearance -- Java 8");
