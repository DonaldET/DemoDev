...
public class TreeMapSearcher implements SieveSearcher {
	...
	private int[] copyToArray(final int topCount, final Map<Integer, Integer> topPicks) {
		final int[] results = new int[topCount];

		final Iterator<Entry<Integer, Integer>> topPickItr = topPicks.entrySet().iterator();
