...
public class DataMetricsBean {
	...
	public DataMetricsBean(final Set<String> complete, final Set<String> incomplete, final Set<String> duplicate,
			final Set<String> nullEntries) {
		super();
	...
	public String toString() {
		...
		msg.append(complete);
		msg.append(";\n  incomplete: (" + (incomplete == null ? -1 : incomplete.size()) + ") ");
		msg.append(incomplete);
		msg.append(";\n  duplicate   (" + (duplicate == null ? -1 : duplicate.size()) + ") ");
		msg.append(duplicate);
		msg.append(";\n  nulls:      (" + (nullEntries == null ? -1 : nullEntries.size()) + ") ");
