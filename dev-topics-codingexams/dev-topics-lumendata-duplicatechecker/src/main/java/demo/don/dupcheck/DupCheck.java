 ...
 * incomplete.</li>
 * <li>Any two non-null columns are <em>duplicates</em> if their values are the
 * same in the same row.</li>
 * </ul>
 *
...
public class DupCheck {
	...
	private void listInput() {
		final String lead = "*** ";
		System.out.println("\n" + lead + ddr.getLinesRead() + " lines read from " + inputFilePath);
