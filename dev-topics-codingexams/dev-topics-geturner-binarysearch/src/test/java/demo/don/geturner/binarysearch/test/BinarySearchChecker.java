...
public abstract class BinarySearchChecker
{
  ...
  {
    Assert.assertTrue("wrong find",
        search.find(null, 0) == BinarySearch.KEY_NOT_FOUND);
  }
  ...
  {
    Assert.assertTrue("wrong find",
        search.find(new Integer[0], null) == BinarySearch.KEY_NOT_FOUND);
  }
  ...
  public void testArray0()
  {
    ...
    Assert.assertEquals("lth0 not there found", BinarySearch.KEY_NOT_FOUND,
  ...
  public void testArray1()
  {
    ...
    Assert.assertEquals("lth1 not there found", BinarySearch.KEY_NOT_FOUND,
        search.find(array, notKey));
  }
  ...
  public void testArray2()
  {
    ...
    final Integer notKey = 17;
    Assert.assertEquals("lth2 not there found", BinarySearch.KEY_NOT_FOUND,
        search.find(array, notKey));
  }
  ...
  public void testArray3()
  {
    ...
    final Integer notKey = 17;
    Assert.assertEquals("lth3 not there found", BinarySearch.KEY_NOT_FOUND,
        search.find(array, notKey));
  }
  ...
  private void checkArray(final int lth)
  {
    ...
    key = 1;
    Assert.assertEquals("lth" + lth + " not found for " + key,
        Arrays.binarySearch(array, key), search.find(array, key));
