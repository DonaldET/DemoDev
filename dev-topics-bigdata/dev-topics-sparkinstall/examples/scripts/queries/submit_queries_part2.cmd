...
setlocal
set x_script=$0
set x_driver=part2.py

echo.
echo. Summit Spark Queries II script using driver %x_driver% on %SPARK_HOME% executing %x_script%.cmd
set x_base=%~dp0
