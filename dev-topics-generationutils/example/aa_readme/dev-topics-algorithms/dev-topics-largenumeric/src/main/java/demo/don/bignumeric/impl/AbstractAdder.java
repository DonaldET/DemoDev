...
public abstract class AbstractAdder implements Adder
{
  ...
  protected AbstractAdder(final SequenceGenerator generator,
  ...
  public String toString()
  {
    return "[" + getClass().getSimpleName() + " - 0x"
        + Integer.toHexString(hashCode()) + ";  name: " + getName()
        + ";  maxIterations: " + maxIterations + ";  generator: " + generator
        + ";  element: " + element + ";  iteration: " + iteration + ";  sum: "
        + sum + ";  lastSum: " + lastSum + "]";
  }
}