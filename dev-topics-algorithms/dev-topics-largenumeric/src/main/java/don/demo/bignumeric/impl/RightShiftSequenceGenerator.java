...
public class RightShiftSequenceGenerator implements SequenceGenerator {
	...
	public float correctSum() {
		return (float) (2.0 * element * initialFactor * (1.0 - 1.0 / Math.pow(2.0, iteration)));
	}
	...
	public String toString() {
		return "[" + getClass().getSimpleName() + " - 0x" + Integer.toHexString(hashCode()) + ";  iteration: "
				+ iteration + ";  factor:" + factor + "(step: " + factorStep + ");  element: " + element + "]";
	}
}
