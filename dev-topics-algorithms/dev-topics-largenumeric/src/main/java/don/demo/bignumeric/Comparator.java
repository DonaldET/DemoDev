...
public class Comparator {
	...
	/**
	 * Adds a sequence of bounded, positive, randomly computed floating point values
	 * using simple addition and the Kahan summation algorithm; the errors of both
	 * approaches are compared. <strong>Note:</strong>
	 * <p>
	 ...
	 * <p>
	 *
	 * @param args runtime argument; ignored
	 */
	public static void main(final String[] args) {
		final List<Integer> testSizes = Arrays.asList(10, 25, 50, 75, 100, 125, 150, 200, 250, 300, 500, 1000, 1500,
				2000, 2500, 3000);

		System.out.println("Single Precision Floating Point Addition Algorithm Comparison");
		System.out.format("\n%3s.%1s%4s %12s %12s %12s %8s %8s %8s", "Set", " ", "  N", "Naive", "Kahan", "True",
				"N ERR", "K ERR", "%REL");
		...
		for (final int size : testSizes) {
			...
			System.out.format("\n%3d.%1s%4d", tnum, naiveResult.equals(kahanResult) ? " " : "*", size);
