...
public class TestPropertyModelBuilder {
    ...
    public void testEmptyPropertiesBuilder() {
        modelBuilder.clear();
        Assert.assertEquals("new builder not empty", 0, modelBuilder.build()
                .size());
    }
    ...
    public void testModelAugment() {
        ...
        Assert.assertTrue("simple augment failed",
                aug.equals(augmented.build()));
    }
    ...
    public void testModelAugmentOverride() {
        ...
        Assert.assertEquals("simple augment failed", aug,
                modelBuilder.augment(aug).build());
        ...
        Assert.assertEquals("override augment failed", augExp, modelBuilder
                .augment(augOvr).build());
    }
    ...
    public void testLoadFlatPropertiesFile() {
        ...
        modelBuilder.clear();
        final Properties finished = modelBuilder.augment(model)
                .augment(modelOver).build();
        ...
        Assert.assertEquals("file based override augment failed", modelExp,
                finished);
    }
}
