...
public interface Generator extends Serializable {
     ...
     * model/context
     * 
     * @param composedPropertiesModel
     *            the model or context for code generation
     * @param srcDir
     *            the common source directory for the templates in the pair list
     * @param pairs
     *            the input-output specifications for generation
     * 
